...
4. [Como funciona a interação entre sistemas?](#como-funciona-a-interao-entre-sistemas)
5. [Protocol Buffers](#protocol-buffers)
6. [Tipos de serviço](#tipos-de-servio)
   - [Envio único, resposta única (unário)](#envio-nico-resposta-nica-unrio)
   - [Envio único, sequência de respostas](#--sequncia-de-envios-sequncia-de-respostas)
   - [Sequência de envios, única resposta](#--sequncia-de-envios-nica-resposta)
   - [Sequência de envios, sequência de respostas](#--sequncia-de-envios-sequncia-de-respostas)
7. [Tempo limite, cancelamento e finalização](#tempo-limite-cancelamento-e-finalizao)
8. [Metadados](#metadados)
9. [Canais](#canais)
10. [Na prática](#na-prtica)
    - [Depencências](#dependncias)
    ...
    - [Implementando a lógica de negócio nos serviços gRPC](#implementando-a-lgica-de-negcio-nos-servios-grpc)
    - [Segurança com JWT](#segurana-com-jwt)
